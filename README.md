...
#### v1.3
Оказывается расширение ключа не работало - потому что каждый раз исходные ключи перезаписывались на основе предыдущего шифрования, а не исходного числа. Теперь все работает, шифрует большие файли нормально и криптостойкость должна быть хорошей т.к. ключи и Sbox реально расширяются. В основном все. Но русские символы до сих пор не воспринимает

#### v1.3.1
Фикс мелких багов, доработал код. Русские символы поддерживает только в файлах
